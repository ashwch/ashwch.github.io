# Archived Pelican stack

This directory preserves the pre-Astro Pelican setup for historical reference.

Important:

- the live site is no longer served by this stack
- current production now runs from the Astro app at `site/`
- root `content/` remains the canonical content source for the repository
- the files in this archive are preserved for reference and historical recovery; they are not the active deployment path
