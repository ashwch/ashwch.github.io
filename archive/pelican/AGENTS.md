...
This directory is an archived snapshot of the old Pelican/GitHub Pages workflow.

Do not use it as the current deployment guide for `ashwch.com`.

Current production now runs from the Astro app in `site/` and is deployed through Cloudflare Pages.

Treat the instructions below as historical guidance, not the active release process.
